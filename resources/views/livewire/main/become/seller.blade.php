<div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 mt-[7rem] py-12 lg:pt-16 lg:pb-24">
    ...
    src="{{ placeholder_img() }}" 
    data-src="{{ Storage::disk('s3')->url('storage/Purple%20and%20Blue%20Pastel%203D%20Gradient%20Marketing%20Strategy%20Infographic%20Instagram%20Post.png') }}" 
    alt="{{ __('messages.t_u_bring_the_skill_make_earn_easy') }}">
