...
<!--   @if($gig->thumbnail)-->
<a href="{{ url('service', $gig->slug) }}" class="flex items-center justify-center overflow-hidden w-full h-52 bg-gray-100 dark:bg-zinc-700">
    <img class="object-contain max-h-52 lazy h-52 w-auto" width="200" data-src="https://s3.ap-south-1.amazonaws.com/gigfly.in/gigs/previews/medium/{{ $gig->thumbnail->file_name }}" alt="{{ $gig->title }}">
</a>

<!--<a href="{{ url('service', $gig->slug) }}" class="flex items-center justify-center overflow-hidden w-full h-52 bg-gray-100 dark:bg-zinc-700">-->
<!--    <img class="object-contain max-h-52 lazy h-52 w-auto" width="200" src="{{ $gig->thumbnail->file_url }}" alt="{{ $gig->title }}">-->
<!--</a>-->
...
<!--    <img class="object-contain max-h-52 lazy h-52 w-auto" width="200" src="{{ $gig->thumbnailUrl}}" alt="{{ $gig->title }}">-->
<!--</a>-->
                        ...
                        <div class="flex items-center">
                            <span class="inline-block relative">
                                ...
                                @else
                                    ...
                                    @endphp
                                    <div class="flex items-center justify-center h-8 w-8 text-sm uppercase rounded-full font-medium" style="background-color: rgba({{ $color }}, .1);color: rgb({{ $color }})">
                                        {{ Str::substr($gig->owner->username, 0, 2) }}
                                    </div>   
                                @endif
                            </span>
