        ...
        <div class="flex flex-col justify-start ltr:ml-1.5 rtl:mr-1.5">
            ...
            @if(@$attachment[2] == 'file')
                <div class="mt-2 w-fit bg-gray-200 dark:bg-zinc-700 rounded-md py-2 px-3" dir="{{ config()->get('direction') }}">
                 ...
                 <a href="https://s3.ap-south-1.amazonaws.com/gigfly.in/attachments/{{ $attachment[0] }}" class="text-blue-600 hover:underline disabled:text-gray-400 disabled:cursor-not-allowed disabled:pointer-events-none disabled:no-underline">@lang('messages.t_download')</a>
            ...
            <!--      <div class="image-file chat-image w-60 h-48" style="background-image: url('{{ Storage::disk('s3')->url($attachment[0]) }}')"></div>-->
...
@if($attachment[2] == 'image')
    ...
    @endphp
    <div class="image-file chat-image w-60 h-48" style="background-image: url('{{ $imageUrl }}')"></div>
@endif
            {{-- Message date --}}
