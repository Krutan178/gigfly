...
Route::middleware(['web', 'auth:admin'])->group(function() {
    ...
    Route::namespace('Users')->prefix('users')->group(function() {
        ...
        Route::namespace('Options')->group(function() {
            ...
            // Message
            Route::get('message/{id}', MessageComponent::class);

            // Restrict
            Route::get('restrict/{id}', RestrictComponent::class);
    ...
    Route::namespace('Packages')->prefix('packages')->group(function() {
        ...
        // All
        Route::get('/', PackagesComponent::class);
    ...
    // Attributes
    Route::namespace('Attributes')->prefix('attributes')->group(function() {

        // All
        Route::get('/', AttributesComponent::class);
    ...
    Route::namespace('Support')->prefix('support')->group(function() {
        ...
        // Reply
        Route::get('reply/{id}', ReplyComponent::class);
    ...
    Route::namespace('Newsletter')->prefix('newsletter')->group(function() {
        ...
        // Send
        Route::get('send/{id}', SendComponent::class);
    ...
    Route::namespace('Services')->prefix('services')->group(function() {
        ...
        // Cloud storage
        Route::namespace('Cloud')->prefix('cloud')->group(function() {

            // All
            Route::get('/', IndexComponent::class);

            // Amazon S3
            Route::get('amazon', AmazonComponent::class);

            // Wasabi
            Route::get('wasabi', WasabiComponent::class);
