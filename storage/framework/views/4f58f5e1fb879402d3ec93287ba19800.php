<div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 mt-[7rem] py-12 lg:pt-16 lg:pb-24" x-data="window.LVoePqYZdmjQURo" x-init="initialize">
                        ...
                        <dl>
                            ...
                            <div class="bg-white dark:bg-zinc-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                ...
                                <dd class="mt-1 text-sm text-zinc-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
                                    <?php echo e(money($project->budget_min, settings('currency')->code, true), false); ?> – <?php echo e(money($project->budget_max, settings('currency')->code, true), false); ?>
							...
							<div class="bg-gray-50 dark:bg-zinc-600 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
								...
								<dd class="mt-1 text-sm text-gray-900 dark:text-white sm:col-span-2 sm:mt-0 font-semibold">
									<?php echo e(money($avg_bid, settings('currency')->code, true), false); ?>
									...
									<div class="relative flex items-center w-full py-4">
										...
										<div class="ltr:ml-4 rtl:mr-4 text-sm w-full">
											<label for="bid-promotion-plan-<?php echo e($plan->uid, false); ?>" class="font-medium text-gray-700 flex items-center justify-between">
												...
												<span class="text-sm font-semibold text-zinc-700 bg-gray-100 rounded-md px-3 py-2 dark:bg-zinc-900 dark:text-zinc-200"><?php echo e(money($plan->price, settings('currency')->code, true), false); ?></span>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/main/project/project.blade.php ENDPATH**/ ?>