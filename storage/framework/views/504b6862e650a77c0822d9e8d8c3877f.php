<div>
    ...
    <div x-data="LivewireUISpotlight({
        componentId: '<?php echo e($this->id(), false); ?>',
        placeholder: '<?php echo e(trans('livewire-ui-spotlight::spotlight.placeholder'), false); ?>',
        commands: <?php echo \Illuminate\Support\Js::from($commands)->toHtml() ?>,
        showResultsWithoutInput: '<?php echo e(config('livewire-ui-spotlight.show_results_without_input'), false); ?>',
    })"
         x-init="init()"
         x-show="isOpen"
         x-cloak
         <?php $__currentLoopData = config('livewire-ui-spotlight.shortcuts'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            @keydown.window.prevent.cmd.<?php echo e($key, false); ?>="toggleOpen()"
            @keydown.window.prevent.ctrl.<?php echo e($key, false); ?>="toggleOpen()"
...
<?php /**PATH /home/gigfly.in/public_html/resources/views/vendor/livewire-ui-spotlight/spotlight.blade.php ENDPATH**/ ?>