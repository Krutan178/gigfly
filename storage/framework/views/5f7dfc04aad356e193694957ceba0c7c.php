			...
			<div class="h-80 w-full absolute bottom-0 xl:inset-0 xl:h-full">
				<div class="h-full w-full xl:grid xl:grid-cols-2">
					<div class="h-full xl:relative xl:col-start-2">
						...
						<img class="h-full w-full object-cover opacity-25 xl:absolute xl:inset-0 ltr:rounded-r-lg rtl:rounded-l-lg lazy" 
    src="<?php echo e(placeholder_img(), false); ?>" 
    data-src="<?php echo e(Storage::disk('s3')->url('storage/Purple%20and%20Blue%20Pastel%203D%20Gradient%20Marketing%20Strategy%20Infographic%20Instagram%20Post.png'), false); ?>" 
    alt="<?php echo e(__('messages.t_u_bring_the_skill_make_earn_easy'), false); ?>">

						<div aria-hidden="true" class="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-zinc-900 xl:inset-y-0 ltr:xl:left-0 rtl:xl:right-0 xl:h-full xl:w-32 xl:bg-gradient-to-r rtl:rotate-180" style="display: none;"></div>
					</div>
				</div>
			</div>
					...
					<div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
						...
						<p>
							<span class="block text-xl font-bold text-white uppercase">
								<?php echo e(money(5, settings('currency')->code, true), false); ?> - <?php echo e(money(10000, settings('currency')->code, true), false); ?>
...
</div><?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/main/become/seller.blade.php ENDPATH**/ ?>