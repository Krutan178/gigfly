                    ...
                    <div>
                        ...
                        <dl class="mt-2 divide-y divide-gray-200 border-t border-b border-gray-200 dark:divide-zinc-600 dark:border-zinc-600">
                            ...
                            <div class="flex justify-between py-3 text-sm font-medium">
                                ...
                                <dd class="text-gray-900 dark:text-gray-200  font-extrabold"><?php echo e(money($refund->item->profit_value, settings('currency')->code, true), false); ?></dd>
                            </div>
...
</div><?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/main/seller/refunds/options/details.blade.php ENDPATH**/ ?>