...
<a href="<?php echo e(url('service', $gig->slug), false); ?>" class="flex items-center justify-center overflow-hidden w-full h-52 bg-gray-100 dark:bg-zinc-700">
    <img class="object-contain max-h-52 lazy h-52 w-auto" width="200" data-src="https://s3.ap-south-1.amazonaws.com/gigfly.in/gigs/previews/medium/<?php echo e($gig->thumbnail->file_name, false); ?>" alt="<?php echo e($gig->title, false); ?>">
</a>

<!--<a href="<?php echo e(url('service', $gig->slug), false); ?>" class="flex items-center justify-center overflow-hidden w-full h-52 bg-gray-100 dark:bg-zinc-700">-->
<!--    <img class="object-contain max-h-52 lazy h-52 w-auto" width="200" src="<?php echo e($gig->thumbnail->file_url, false); ?>" alt="<?php echo e($gig->title, false); ?>">-->
<!--</a>-->
...
<!--    <img class="object-contain max-h-52 lazy h-52 w-auto" width="200" src="<?php echo e($gig->thumbnailUrl, false); ?>" alt="<?php echo e($gig->title, false); ?>">-->
<!--</a>-->
...
<?php $__env->stopPush(); ?><?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/main/cards/gig.blade.php ENDPATH**/ ?>