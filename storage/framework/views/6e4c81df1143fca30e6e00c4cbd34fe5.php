        ...
        <div class="flex flex-col justify-start ltr:ml-1.5 rtl:mr-1.5">
            ...
            <?php if(@$attachment[2] == 'file'): ?>
                <div class="mt-2 w-fit bg-gray-200 dark:bg-zinc-700 rounded-md py-2 px-3" dir="<?php echo e(config()->get('direction'), false); ?>">
                 ...
                 <a href="https://s3.ap-south-1.amazonaws.com/gigfly.in/attachments/<?php echo e($attachment[0], false); ?>" class="text-blue-600 hover:underline disabled:text-gray-400 disabled:cursor-not-allowed disabled:pointer-events-none disabled:no-underline"><?php echo app('translator')->get('messages.t_download'); ?></a>
            ...
            <!--      <div class="image-file chat-image w-60 h-48" style="background-image: url('<?php echo e(Storage::disk('s3')->url($attachment[0]), false); ?>')"></div>-->
...
<?php if($attachment[2] == 'image'): ?>
    <?php
        $imagePath = urlencode($attachment[0]);
        $imageUrl = env('AWS_URL') . 'attachments/' . $imagePath;
    ?>
    <div class="image-file chat-image w-60 h-48" style="background-image: url('<?php echo e($imageUrl, false); ?>')"></div>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/gigfly.in/public_html/resources/views/vendor/Chatify/layouts/messageCard.blade.php ENDPATH**/ ?>