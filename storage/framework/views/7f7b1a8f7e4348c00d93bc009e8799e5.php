                                            ...
                                            <dl class="grid grid-cols-2 gap-x-6 text-sm">
                                                <div>
                                                    ...
                                                    <dd class="mt-3 text-gray-500 dark:text-gray-300">
                                                        <span class="block"><?php echo e(money($item->total_value, settings('currency')->code, true), false); ?></span>
                                                    </dd>
                                                </div>
                                                <div>
...
<?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/main/account/refunds/options/request.blade.php ENDPATH**/ ?>