                                        ...
                                        <div class="flex flex-col grow md:flex-row md:space-x-6 md:space-y-0 rtl:space-x-reverse space-y-4 w-full">
                                            ...
                                            <div class="flex-none md:w-48 space-y-4 md:ltr:pr-1 md:rtl:pl-1">
                                                ...
                                                <div class="bg-gray-100 flex flex-col items-center justify-center p-3 rounded-lg dark:bg-zinc-700">
                                                    ...
                                                    <span class="text-base font-medium tracking-wide text-zinc-600 dark:text-zinc-200"><?php echo e(money($gig->price, settings('currency')->code, true), false); ?></span>
                                                </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_budget')),'placeholder' => '0.00','model' => 'budget','suffix' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(config('money.currencies.' . mb_strtoupper( settings('currency')->code ))['symbol'])]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/main/profile/profile.blade.php ENDPATH**/ ?>