    ...
    <div class="lg:flex lg:items-center lg:justify-between mb-14">
        ...
        <div class="min-w-0 flex-1">
            ...
            <h2 class="text-lg font-bold leading-7 text-zinc-700 dark:text-gray-50 sm:truncate sm:text-xl sm:tracking-tight">
                <?php echo app('translator')->get('dashboard.t_childcategories'); ?>
            </h2>
        ...
        <div class="mt-5 flex lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4 justify-between">
            ...
            <a href="<?php echo e(admin_url('childcategories/create'), false); ?>" class="btn p-2.5 hover:shadow-none ring-slate-300 dark:ring-zinc-600 focus:ring-offset-2 focus:ring-offset-slate-300 dark:focus:ring-offset-zinc-600 space-x-2 rtl:space-x-reverse border">
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th><?php echo app('translator')->get('dashboard.t_childcategory'); ?></th>
                        <th><?php echo app('translator')->get('messages.t_subcategory'); ?></th>
                        <th><?php echo app('translator')->get('messages.t_parent_category'); ?></th>
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $childcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr wire:key="childcategories-<?php echo e($childcategory->uid, false); ?>">
                                ...
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    <div class="h-10 w-10 inline-flex flex-shrink-0 relative">
                                        <?php if($childcategory->icon): ?>
                                            <img class="mask is-squircle object-cover w-full h-full block" src="<?php echo e(src($childcategory->icon), false); ?>" alt="<?php echo e($childcategory->name, false); ?>">
                                        <?php else: ?>
                                            <?php
                                            ...
                                            <div class="flex items-center justify-center h-full w-full mask is-squircle text-sm uppercase dark:bg-navy-500 dark:text-navy-100 font-medium" style="background-color: rgba(<?php echo e($color, false); ?>, .1);color: rgb(<?php echo e($color, false); ?>)">
                                                <?php echo e(Str::substr($childcategory->name, 0, 2), false); ?>

                                            </div>   
                                        <?php endif; ?>
                                    </div>
                                    <div>
                                        <a href="<?php echo e(url('categories/' . $childcategory->parent->slug . '/' . $childcategory->subcategory->slug . '/' . $childcategory->slug), false); ?>" target="_blank" class="text-sm font-semibold whitespace-nowrap dark:text-zinc-100">
                                            <?php echo e($childcategory->name, false); ?>

                                        </a>
                                        <div class="text-slate-500 text-xs whitespace-nowrap mt-px dark:text-zinc-300">
                                            <?php echo e($childcategory->slug, false); ?>
                            ...
                            <td>
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    <div class="h-10 w-10 inline-flex flex-shrink-0 relative">
                                        <?php if($childcategory->subcategory->icon): ?>
                                            <img class="mask is-squircle object-cover w-full h-full block" src="<?php echo e(src($childcategory->subcategory->icon), false); ?>" alt="<?php echo e($childcategory->subcategory->name, false); ?>">
                                        <?php else: ?>
                                            <?php
                                                $faker = Faker\Factory::create();
                                                $color = $faker->rgbColor();
                                            ?>
                                            <div class="flex items-center justify-center h-full w-full mask is-squircle text-sm uppercase dark:bg-navy-500 dark:text-navy-100 font-medium" style="background-color: rgba(<?php echo e($color, false); ?>, .1);color: rgb(<?php echo e($color, false); ?>)">
                                                <?php echo e(Str::substr($childcategory->subcategory->name, 0, 2), false); ?>

                                            </div>   
                                        <?php endif; ?>
                                    </div>
                                    <div>
                                        <a href="<?php echo e(url('categories/' . $childcategory->parent->slug . '/' . $childcategory->subcategory->slug), false); ?>" target="_blank" class="text-sm font-semibold whitespace-nowrap dark:text-zinc-100">
                                            <?php echo e($childcategory->subcategory->name, false); ?>

                                        </a>
                                        <div class="text-slate-500 text-xs whitespace-nowrap mt-px dark:text-zinc-300">
                                            <?php echo e($childcategory->subcategory->slug, false); ?>
                            ...
                            <td>
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    <div class="h-10 w-10 inline-flex flex-shrink-0 relative">
                                        <?php if($childcategory->parent->icon): ?>
                                            <img class="mask is-squircle object-cover w-full h-full block" src="<?php echo e(src($childcategory->parent->icon), false); ?>" alt="<?php echo e($childcategory->parent->name, false); ?>">
                                        <?php else: ?>
                                            <?php
                                                $faker = Faker\Factory::create();
                                                $color = $faker->rgbColor();
                                            ?>
                                            <div class="flex items-center justify-center h-full w-full mask is-squircle text-sm uppercase dark:bg-navy-500 dark:text-navy-100 font-medium" style="background-color: rgba(<?php echo e($color, false); ?>, .1);color: rgb(<?php echo e($color, false); ?>)">
                                                <?php echo e(Str::substr($childcategory->parent->name, 0, 2), false); ?>

                                            </div>   
                                        <?php endif; ?>
                                    </div>
                                    <div>
                                        <a href="<?php echo e(url('categories', $childcategory->parent->slug), false); ?>" target="_blank" class="text-sm font-semibold whitespace-nowrap dark:text-zinc-100">
                                            <?php echo e($childcategory->parent->name, false); ?>

                                        </a>
                                        <div class="text-slate-500 text-xs whitespace-nowrap mt-px dark:text-zinc-300">
                                            <?php echo e($childcategory->parent->slug, false); ?>
                            ...
                            <td class="text-center">
                                <span class="text-sm font-semibold text-gray-500 dark:text-zinc-300"><?php echo e($childcategory->gigs_count, false); ?></span>
                            </td>

                            
                            <td class="text-center">
                                <span class="text-sm font-semibold text-gray-500 dark:text-zinc-300"><?php echo e($childcategory->projects_count, false); ?></span>
                            </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.action-button','data' => ['icon' => 'pencil','title' => __('messages.t_edit'),'href' => ''.e(admin_url('childcategories/edit/' . $childcategory->uid), false).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'pencil','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_edit')),'href' => ''.e(admin_url('childcategories/edit/' . $childcategory->uid), false).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginal25db5b2b4ed745b6b0fe0dc3034b2fb4 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal25db5b2b4ed745b6b0fe0dc3034b2fb4 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.action-button','data' => ['icon' => 'trash','iconColor' => 'text-red-600','title' => __('messages.t_delete'),'href' => ''.e(admin_url('childcategories/delete/' . $childcategory->uid), false).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('table.action-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'trash','icon-color' => 'text-red-600','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_delete')),'href' => ''.e(admin_url('childcategories/delete/' . $childcategory->uid), false).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal25db5b2b4ed745b6b0fe0dc3034b2fb4)): ?>
<?php $attributes = $__attributesOriginal25db5b2b4ed745b6b0fe0dc3034b2fb4; ?>
...
<?php endif; ?>
    ...
    <?php if($childcategories->hasPages()): ?>
        <div class="bg-gray-100 px-4 py-5 sm:px-6 rounded-bl-lg rounded-br-lg flex justify-center border-t-0 border-r border-l border-b">
            <?php echo $childcategories->links('pagination::tailwind'); ?>

        </div>
    <?php endif; ?>

</div><?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/admin/childcategories/childcategories.blade.php ENDPATH**/ ?>