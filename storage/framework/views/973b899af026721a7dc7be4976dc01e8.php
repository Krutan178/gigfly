<div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 mt-[7rem] py-12 lg:pt-16 lg:pb-24" x-data="window.oZcfXWmBuWfxbIo" x-init="initialize()">
    ...
    <li class="splide__slide dark:bg-zinc-700 bg-gray-200 object-contain">
        <img src="<?php echo e(Storage::disk('s3')->url('gigs/gallery/large/' . $image->large->file_name), false); ?>" alt="<?php echo e($gig->title, false); ?>" class="object-contain">
    </li>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/main/service/service.blade.php ENDPATH**/ ?>