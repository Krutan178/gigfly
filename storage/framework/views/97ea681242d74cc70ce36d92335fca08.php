                                                    ...
                                                    <div class="ltr:ml-4 rtl:mr-4 flex flex-1 flex-col">
                                                        <div>
                                                            <div class="flex justify-between text-sm font-medium text-gray-900 dark:text-white">
                                                                ...
                                                                <p class="ltr:ml-5 rtl:mr-5  font-black text-gray-500 dark:text-gray-300 pt-0.5"><?php echo e(money($this->itemTotalPrice($item['id']), settings('currency')->code, true), false); ?></p>
                                                            </div>
                                                        </div>
                        ...
                        <?php if(count($cart)): ?>
                            <div class="border-t border-gray-200 dark:border-zinc-600 py-6 px-4 sm:px-6">
                                <div class="flex justify-between text-base font-medium text-gray-900 dark:text-gray-200">
                                    ...
                                    <p class="font-black"><?php echo e(money($this->total(), settings('currency')->code, true), false); ?></p>
                                </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\Dell\Desktop\gigfly\public_html\resources\views/livewire/main/partials/cart.blade.php ENDPATH**/ ?>