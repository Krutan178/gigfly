                                            ...
                                            <td class="ltr:pl-4 rtl:pr-4">
                                                <a href="<?php echo e(url('service', $review->gig->slug), false); ?>" target="_blank" class="flex items-center">
                                                    ...
                                                    <div class="ltr:pl-4 rtl:pr-4">
                                                        ...
                                                        <p class="text-[11px] leading-3 text-gray-600 dark:text-gray-300 pt-2"><?php echo e(money($review->gig->price, settings('currency')->code, true), false); ?></p>
                                                    </div>
                                                </a>
                                            </td>
...
</div><?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/main/account/reviews/reviews.blade.php ENDPATH**/ ?>