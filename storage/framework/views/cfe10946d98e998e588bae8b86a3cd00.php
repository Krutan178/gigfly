									...
									<button 
                                        ...
                                        <div class="h-8 w-8 inline-flex flex-shrink-0 relative">
                                            <?php if(auth()->user()->avatar): ?>
                                                <img class="mask is-squircle object-cover w-full h-full block" src="<?php echo e(src(auth()->user()->avatar), false); ?>" alt="<?php echo e(auth()->user()->username, false); ?>">
                                            <?php else: ?>
                                                <?php
                                                    $faker = Faker\Factory::create();
                                                    $color = $faker->rgbColor();
                                                ?>
                                                <div class="flex items-center justify-center h-full w-full mask is-squircle text-sm uppercase font-medium" style="background-color: rgba(<?php echo e($color, false); ?>, .1);color: rgb(<?php echo e($color, false); ?>)">
                                                    <?php echo e(Str::substr(auth()->user()->username, 0, 2), false); ?>
...
[$__name, $__params] = $__split('main.partials.notifications');

$__html = app('livewire')->mount($__name, $__params, 'IZv2TLn', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'QqeIzlx', $__slots ?? [], get_defined_vars());
...
</html><?php /**PATH /home/gigfly.in/public_html/resources/views/components/layouts/seller-app.blade.php ENDPATH**/ ?>