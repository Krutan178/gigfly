        ...
        <div class="flex items-center gap-4 border-b pb-6 border-slate-100 dark:border-zinc-700 mb-8">
            ...
            <div class="text-muted-700 block text-xl font-semibold">
                <h3 class="text-sm font-bold text-zinc-700 dark:text-white pb-2">
                    <?php echo app('translator')->get('messages.t_create_level'); ?>
                </h3>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bladewind.filepicker','data' => ['name' => 'badge','placeholder' => __('dashboard.t_upload_level_badge_icon'),'acceptedFileTypes' => '.jpg,.png,.jpeg,.gif,.svg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'badge','placeholder' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('dashboard.t_upload_level_badge_icon')),'accepted_file_types' => '.jpg,.png,.jpeg,.gif,.svg']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/admin/levels/options/create.blade.php ENDPATH**/ ?>