...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bladewind.select-item','data' => ['label' => 'Amazon S3','value' => 'amazon']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Amazon S3','value' => 'amazon']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/admin/settings/media.blade.php ENDPATH**/ ?>