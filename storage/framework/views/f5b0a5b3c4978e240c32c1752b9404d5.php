                    ...
                    <dl>
                        ...
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-[13px]  font-extrabold text-gray-900 sm:mt-0 sm:col-span-2">
                                <?php echo e(money($refund->item->total_value, settings('currency')->code, true), false); ?>
...
<?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/admin/refunds/options/details.blade.php ENDPATH**/ ?>