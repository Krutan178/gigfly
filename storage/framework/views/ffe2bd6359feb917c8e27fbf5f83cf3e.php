                                    ...
                                    <aside class="mt-8 xl:hidden">
                                        <div class="space-y-5">
                                            ...
                                            <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                                ...
                                                <span class="text-gray-700 dark:text-gray-300 text-sm font-black tracking-wide "><?php echo e(money($refund->item->total_value, settings('currency')->code, true), false); ?></span>
                                            </div>
...
<?php endif; ?>
                        ...
                        <aside class="hidden xl:block xl:ltr:pl-8 xl:rtl:pr-8">
                            <div class="space-y-5">
                                ...
                                <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500 dark:text-gray-400" viewBox="0 0 20 20" fill="currentColor"> <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"/> <path fill-rule="evenodd" d="M18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z" clip-rule="evenodd"/></svg>
                                    <span class="text-gray-700 dark:text-gray-200 text-sm font-black tracking-wide "><?php echo e(money($refund->item->total_value, settings('currency')->code, true), false); ?></span>
                                </div>
...
<?php /**PATH /home/gigfly.in/public_html/resources/views/livewire/main/account/refunds/options/details.blade.php ENDPATH**/ ?>